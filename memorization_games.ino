...
// Constants
const int button1 = 2;          // 1st button LED 
const int button2 = 3;          // 2nd button LED
const int button3 = 4;          // 3rd button LED
const int button4 = 5;          // 4th button LED
const int led1 = 7;             // LED
const int led2 = 8;             // LED
const int led3 = 9;             // LED
const int led4 = 10;            // LED
const int buzzer = 12;          // Buzzer Output
const int tones[] = {1915, 1700, 1519, 1432, 2700}; // tones when you press the LED's- when you fail.
...
int game_on = 0;
int wait = 0;
int currentlevel = 1; // level (also the number of button presses to pass to next level)
...
int butwait = 500; // wait for next button input (ghetto de-bounce)
int ledtime = 500; // time each LED flashes for when button is pressed
...
int speedfactor = 5; //This is the final speed of the lights and sounds and show you are won.
int leddelay = 200; //Introducing time for LED. This will diminish as the level increments
...
//if you complete the right way it levels up
if (right == 1){
    currentlevel++;
    wait = 0;
    }
...
//sets game_on to 0, its working restarts a new game
game_on = 0;
currentlevel = 1;
n_levels = n_levels + 2;
